...
appid = os.environ.get("VOLC_ASR_APPID", "your_volc_appid_here")
token = os.environ.get("VOLC_ASR_TOKEN", "your_volc_token_here")
cluster = "volcengine_input_common"
audio_path = "./demos/dog_agent/myrec.wav"
audio_format = "wav"
