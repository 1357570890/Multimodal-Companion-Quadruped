...
START_THRESHOLD = 100000  # 开始录音的音量阈值，此处无效 The volume threshold for starting recording is invalid here
END_THRESHOLD = 60000  # 停止录音的音量阈值，此处无效 The volume threshold for stopping recording is invalid here
ENDLAST = 30
